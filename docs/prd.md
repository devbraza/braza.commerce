...
8. Click_id incluído na mensagem de forma **completamente invisível** usando codificação zero-width unicode (U+200B, U+200C, U+200D, U+2060). O cliente vê apenas a mensagem normal sem nenhum código visível. O sistema decodifica os caracteres zero-width ao receber a mensagem no webhook para vincular o lead à campanha
